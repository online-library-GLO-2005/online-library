...
export async function postCommentToBook(id:number, message:string): Promise<ApiSuccess> {
...
export async function updateBook(id:number, data:Partial<Book>): Promise<ApiSuccess> {
